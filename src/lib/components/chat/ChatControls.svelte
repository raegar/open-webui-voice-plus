...
<script lang="ts">
	...
	// Derive latest generated image — keyed off history.currentId so it
	// re-runs when messages change (bind:history mutates without ref change)
	let latestGeneratedImage: string | null = null;
